...
# ==========================================
nota_1 = float(input()) # pesoa 2
nota_2 = float(input()) # peso 3
nota_3 = float(input()) # peso 5

# ==========================================
# Processamento: Cálculo da Média do Aluno
# ==========================================
calculo_media = (nota_1 * 2) + (nota_2 * 3) + (nota_3 * 5)
media_final = calculo_media / 10 # Multiplicando pela soma dos pesos

# ==========================================
# Saída: dados calculados e formatados
# ==========================================
print("MEDIA = {:.1f}".format(media_final))